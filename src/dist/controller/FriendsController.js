...
const unFriend = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const Friend = yield userModel_1.default.findById(friendID);
        if (User && Friend) {
            yield ((_c = User.friends) === null || _c === void 0 ? void 0 : _c.pull(new mongoose_1.default.Types.ObjectId(friendID)));
            User.save();
            yield ((_d = Friend.friends) === null || _d === void 0 ? void 0 : _d.pull(new mongoose_1.default.Types.ObjectId(userID)));
            Friend.save();
            return res.status(mainError_1.HTTP.CREATED).json({

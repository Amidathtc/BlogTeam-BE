...
const likeArticleComment = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (user) {
            (_b = comment === null || comment === void 0 ? void 0 : comment.likes) === null || _b === void 0 ? void 0 : _b.push(new mongoose_1.default.Types.ObjectId(user._id));
...
const unLikeArticleComment = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const comment = yield commentModel_1.default.findById(commentID);
        if (user) {
            (_c = comment === null || comment === void 0 ? void 0 : comment.likes) === null || _c === void 0 ? void 0 : _c.pull(new mongoose_1.default.Types.ObjectId(user._id));
            comment === null || comment === void 0 ? void 0 : comment.save();
            return res.status(201).json({
...
const deleteOneComment = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        (_d = article === null || article === void 0 ? void 0 : article.comments) === null || _d === void 0 ? void 0 : _d.pull(new mongoose_1.default.Types.ObjectId(commentID));
        article.save();
        return res.status(201).json({
            message: "read Post comment",
            data: comment,
